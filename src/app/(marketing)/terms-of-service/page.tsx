    ...
    <PolicyPage
      ...
      sections={[
        ...
        },
        {
          ...
          paragraphs: [
            `The Free plan is available indefinitely without payment. The ${TRIAL.name} is a single payment of $${TRIAL.oneTimePrice} that opens the paid features for ${TRIAL.trialDays} days, is limited to one per person, and becomes a ${CONVERTS_TO.name} subscription at $${CONVERTS_TO.priceMonthly} a month unless cancelled within those ${TRIAL.trialDays} days. Paid plans renew automatically until cancelled.`,
