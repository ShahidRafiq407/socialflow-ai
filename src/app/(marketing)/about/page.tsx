    ...
    <div className="mkt-bg mkt-text">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8">
          <div className="rounded-3xl border mkt-border mkt-surface p-8">
            <Building2 className="w-10 h-10 mkt-accent-text mb-5" />
            <h2 className="text-2xl font-bold mb-4">The Parent Company — SMB Robotics</h2>
            <p className="mkt-muted leading-relaxed mb-4">
          ...
          <div className="rounded-3xl border mkt-border mkt-surface p-8">
            <Bot className="w-10 h-10 mkt-accent2-text mb-5" />
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            {[
              ...
              <div key={v.title} className="rounded-3xl border mkt-border mkt-surface p-7 text-center">
                <v.icon className="w-8 h-8 mx-auto mb-4 mkt-accent-text" />
                <h3 className="font-bold mb-2">{v.title}</h3>
                <p className="text-sm mkt-faint leading-relaxed">{v.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="mkt-muted mb-8 max-w-xl mx-auto">
          We reply fast — usually within a few hours on WhatsApp.
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            href="/contact"
            className="inline-flex items-center justify-center px-8 py-3.5 font-bold rounded-2xl bg-[#18713C] text-white shadow-[0_0_35px_-8px_rgba(24,113,60,0.8)] hover:scale-[1.04] transition-transform"
          >
          ...
          <a
            ...
            className="inline-flex items-center justify-center px-8 py-3.5 font-semibold rounded-2xl border mkt-border mkt-surface hover:mkt-surface2 transition-colors"
          >
