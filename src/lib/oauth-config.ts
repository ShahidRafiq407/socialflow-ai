...
export function getOAuthConfig(platform: string): OAuthPlatformConfig | null {
  const configs: Record<string, OAuthPlatformConfig> = {
    ...
    instagram: {
      ...
      authorizeUrl: "https://www.facebook.com/v21.0/dialog/oauth",
      tokenUrl: "https://graph.facebook.com/v21.0/oauth/access_token",
      scopes: "public_profile,email,instagram_basic,instagram_content_publish,instagram_manage_insights,pages_show_list,pages_read_engagement,pages_manage_posts,business_management",
      clientId: process.env.FACEBOOK_CLIENT_ID || "",
      clientSecret: process.env.FACEBOOK_CLIENT_SECRET || "",
      tokenAuthMethod: "body",
      profileUrl: "https://graph.facebook.com/me?fields=id,name,picture",
